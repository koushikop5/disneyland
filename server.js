...
.map(command =>
  ...
  const Dashboard = new DBD.Dashboard({
    ...
    client: {
      id: process.env["837640531445415979"],
    ...
    invite: {
      ...
      guildAfterAuthorization: { 
        use: true, 
        guildId: "913651224367230986" 
      },
      supportServer: {
        slash: '/support',
        inviteUrl: "https://discord.gg/gdsdWZZZpy"
      },
     theme: DarkDashboard({
      information: {
      ...
      index: {
        card: {
          category: "Alpine - The Aesthetic Multipurpose Bot",
          image: image,
          footer: '↠ Made with love by <a href="https://discord.com/users/779985841090330624"> Koushik#7001 </a>',
        },
        feeds: {
        ...
        information: {
          category: "Alpine - The Aesthetic Multipurpose Bot",
          title: "Information",
          description: `Manage all of functions of Alpine using this Dashboard.`,
          footer: `<a href="https://discord.gg/gdsdWZZZpy"> ↠ Click here to join my Support Server</a>`
        },
      },
      guilds: {
...
`,
          title: "Support",
          link: "https://discord.gg/gdsdWZZZpy",
          id: "support",
        },
        {
...
`,
          title: "Invite Me",
          link: `https://discord.com/api/oauth2/authorize?client_id=${process.env["837640531445415979"]}&permissions=1241204124887&scope=bot%20applications.commands`,
          id: "invite",
        },
        {
